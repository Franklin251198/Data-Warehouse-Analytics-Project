...
└──────────────┘     └──────────────┘     └──────────────┘     └──────────────┘
  ...
  checkin.json
                                                                         ...
                                                                         ▼
┌──────────────┐     ┌──────────────┐     ┌──────────────┐     ┌──────────────┐
│   POWER BI   │◀────│    ODBC      │◀────│     SQL      │◀────│     SQL      │
│  DASHBOARDS  │     │   DRIVER     │     │  ANALYSIS    │     │  DATABASE    │
│              │     │              │     │ (50 Queries) │     │  (SQLite)    │
└──────────────┘     └──────────────┘     └──────────────┘     └──────────────┘
       │                    │                    │                    │
       ▼                    ▼                    ▼                    ▼
  Overview              Connection           CTEs, Window         yelp.db
  Customer Analysis    Configuration         Functions,           (Warehouse
  Business Performance                        Subqueries           Tables)
  Geographic & Time
